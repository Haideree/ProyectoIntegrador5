...
export default function Login() {
  ...
  style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', padding: 0, color: COLORES.textoMuted, lineHeight: 1 }}>
  {verContrasena ? (
