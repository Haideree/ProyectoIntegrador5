...
const {
    ...
    getCultivos, getCultivosByLugar, getCultivosByPredio, getPrediosConRiesgo,
...
router.get("/lugares/:id/cultivos",     getCultivosByLugar);   // ← nuevo
...
router.get("/predios/:id/cultivos",     getCultivosByPredio);  // ← nuevo
